...
public class ModelMappers {
    ...
    public GuaranteeComponentsDto fromGuaranteeToGuaranteeDto(GuaranteeComponents guaranteeComponents) {
        return guaranteeComponents == null ? null : GuaranteeComponentsDto.builder()
                .id(guaranteeComponents.getId())
                .eGuarantee(guaranteeComponents.getEGuarantee())
                .build();
    }

    public GuaranteeComponents fromGuaranteeDtoToGuarantee(GuaranteeComponentsDto guarnteeComponentsDto) {
        return guarnteeComponentsDto == null ? null : GuaranteeComponents.builder()
                .id(guarnteeComponentsDto.getId())
                .eGuarantee(guarnteeComponentsDto.getEGuarantee())
                .products(new HashSet<>())
                .build();
    }
    ...
    public ProductDto fromProductToProductDto(Product product) {
        return product == null ? null : ProductDto.builder()
                ...
                .guarnteeComponentsDto(product.getGuaranteeComponents() == null ? null : fromGuaranteeToGuaranteeDto(product.getGuaranteeComponents()))
                .build();
    }
    ...
    public Product fromProductDtoToProduct(ProductDto productDto) {
        return productDto == null ? null : Product.builder()
                ...
                .stocks(new HashSet<>())
                .customerOrders(new HashSet<>())
                .guaranteeComponents(productDto.getGuarnteeComponentsDto() == null ? null : fromGuaranteeDtoToGuarantee(productDto.getGuarnteeComponentsDto()))
